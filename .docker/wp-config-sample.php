...
define( 'WP_SITEURL', $_SERVER['HTTPS'] === 'on' ? 'https://' : 'http://' . $_SERVER['HTTP_HOST'] . '/wp' );
...
define('WP_DEFAULT_THEME', getenv_docker('WP_DEFAULT_THEME', 'headless'));
...
define('WPMU_PLUGIN_DIR', __DIR__ . '/../bootstrap'); // Full path, no trailing slash.
define('WPMU_PLUGIN_URL', '/bootstrap'); // Full URL, no trailing slash.

if (!file_exists(__DIR__ . '/../vendor/autoload.php')) {
    die('vendor/autoload.php is missing. Please run `composer install`.');
}
